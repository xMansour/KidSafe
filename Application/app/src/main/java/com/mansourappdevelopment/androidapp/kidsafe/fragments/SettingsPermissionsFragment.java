...
public class SettingsPermissionsFragment extends Fragment implements CompoundButton.OnCheckedChangeListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnPermissionsSettingsNext = (Button) view.findViewById(R.id.btnPermissionsSettingsNext);
        ...
        btnPermissionsSettingsPrev = (Button) view.findViewById(R.id.btnPermissionsSettingsPrev);
